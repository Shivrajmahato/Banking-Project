 ...
 */
public class LoanAccountIntrestRun {
public String LoanAccountIntrestRunReq(String[] param) {
        String request = "";
        ...
        executeFinacleScriptInputVO.put("requestId", "hacint.scr");

        executeFinacleScript_CustomData.put("initSolId", param[1]);
        executeFinacleScript_CustomData.put("loanAccountNumber", param[2]);
        executeFinacleScript_CustomData.put("intrestTillDate", f.format(date));//need to put
 ...
 request = finalJson.toString();
   ...
   public JSONArray LoanAccountIntrestRunRes(String[] param) {
